...
const ANGLES: Angle[] = [
  /* ---------------------------------------------------------------- */
  {
    ...
    w100:
      "Three out of five people die from chronic inflammatory disease. Its drivers are lifestyle, and for most of us the largest lifestyle factor is food. So which food is it? Which Food Is Killing You? puts four suspects on trial — and puts the viewer on the jury. Questions appear during the film; viewers commit to an answer before they learn whether they were right, and their verdicts join a running tally counted alongside every other viewer's. Animated, family-watchable, and built for the argument it starts in the room.",
    w300: [
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    w300: [
      ...
      "And the audience is not a spectator. Questions appear during the film and viewers commit to an answer before the reveal, individually or as a table, with verdicts counted globally. The film ends on a verdict the audience delivers rather than one it is given.",
